...
<div class="container my-4">
    <div class="card card-main p-3">
        ...
        <div class="px-2">
            <form action="<?php echo e(route('produk.index')); ?>" method="GET" class="row g-2 mb-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos_ukk1-main\resources\views/produk/index.blade.php ENDPATH**/ ?>