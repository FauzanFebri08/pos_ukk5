...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>" placeholder="Masukkan nama produk" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="purchase_price" id="purchase_price" class="form-control <?php $__errorArgs = ['purchase_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('purchase_price')); ?>" placeholder="Masukkan harga beli" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="selling_price" id="selling_price" class="form-control <?php $__errorArgs = ['selling_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('selling_price')); ?>" placeholder="Masukkan harga jual" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('stok', 0)); ?>" placeholder="Masukkan jumlah stok" required>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos_ukk1-main\resources\views/produk/create.blade.php ENDPATH**/ ?>