...
<div class="container my-4">
    <div class="card border-0 shadow-sm rounded-4 p-3">
        ...
        <div class="card-body bg-primary text-white rounded-4 p-4 mb-4 d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('jenis.index')); ?>" class="btn btn-light btn-sm fw-bold text-primary rounded-3 px-3">
                ← Kembali
            </a>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos_ukk\resources\views/jenis/create.blade.php ENDPATH**/ ?>