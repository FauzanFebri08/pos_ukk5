                    ...
                    <div class="pos-cart-container card border-0 shadow-sm">
                        ...
                        <div class="card-footer bg-light p-3 border-top-0">
                            <div class="d-flex justify-content-between align-items-center pos-total-box mb-3">
                                ...
                                <strong class="pos-total-amount fs-4 text-primary">Rp {{ number_format($sale->total_pembayaran) }}</strong>
                            ...
                            <form 
                                ...
                                {{-- Choice Method Pembayaran (Dinaikkan agar posisi di atas nominal) --}}
                                <div class="mb-3">
                                    <label for="payment_method" class="form-label small fw-bold text-secondary mb-1">Metode Pembayaran</label>
                                    <select name="payment_method" id="payment_method" class="form-select py-2 fw-semibold" required {{ $sale->status === 'COMPLETED' ? 'disabled' : '' }}>
                                ...
                                <div id="cash_fields">
                                    ...
                                    {{-- Display & Hidden Input Kembalian --}}
                                    <div class="mb-3">
...
{{-- Script Kontrol Tampilan & Hitung Kembalian Otomatis --}}
<script>
